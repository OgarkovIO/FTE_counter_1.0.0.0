...
namespace Loader
{
    public class sminc_entry
    {
        ...
        public sminc_entry(string id_sminc, DateTime date) //Инициализируем класс;
        {
            ID_SmINC = id_sminc;//Создаём параметр amount
        ...
        public string ID_SmINC    //Создаём свойство которое даёт возможность считывать и записывать в поле _amount значения.
        {
            get { return _id_sminc; }  //get - Возвращает значение _amount, return - принудительно завершает выполнение и возвращает значение
            set { _id_sminc = value; } //set - Присваевает значеия, value - хранит значение.
        }
